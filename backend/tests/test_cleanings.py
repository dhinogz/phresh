...
class TestCreateCleaning:
    """Tests for create cleaning endpoint."""
...
class TestGetCleaning:
    """Tests for getting cleaning by id."""
...
class TestDeleteCleaning:
    ...
    async def test_delete_cleaning_with_invalid_inputs_throws_error(
        self,
        app: FastAPI,
        client: AsyncClient,
        test_cleaning: CleaningInDB,
        ...
        """Invalid id to delete throws error."""
