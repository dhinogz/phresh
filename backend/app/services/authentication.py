...
from app.core.config import SECRET_KEY, ACCESS_TOKEN_EXPIRE_MINUTES, JWT_ALGORITHM, JWT_AUDIENCE, JWT_TOKEN_PREFIX
...
class AuthException(BaseException):
    """Custom auth exception that can be modified later."""
    pass


class AuthService:
    """Create salt and generate hashed password service."""
